...
namespace Modelo
{
    class MdfeM1DAL
    {
        ...
        private void Inserir(MdfeM1 m1)
        {

        }

        private void Atualizar(MdfeM1 m1)
        {

        }

        public void Remover(MdfeM1 m1)
        {

        }


        public void PostMdfeM1()
        {
                    ...
                    try
                    {
                        ...
                        using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
                        {
                            if (Convert.ToInt32(dr["Idweb"]) > 0)
                            {
                                ...
                                if (dr["idmdfe"] != DBNull.Value) { m.Idmdfe = (int)dr["idmdfe"]; }
                                if (dr["cnpjemitente"] != DBNull.Value) { m.Cnpjemitente = (string)dr["cnpjemitente"]; }
                                if (dr["ufdestinatario"] != DBNull.Value) { m.Ufdestinatario = (string)dr["ufdestinatario"]; }
                                if (dr["numero"] != DBNull.Value) { m.Numero = (int)dr["numero"]; }
                                if (dr["serie"] != DBNull.Value) { m.Serie = (int)dr["serie"]; }
                                if (dr["dataemissao"] != DBNull.Value) { m.Dataemissao = (DateTime)dr["dataemissao"]; }
                                if (dr["valortotal"] != DBNull.Value) { m.Valortotal = (decimal)dr["valototal"]; }
                                if (dr["suframa"] != DBNull.Value) { m.Suframa = (string)dr["suframa"]; }
                                ...
                                json = json + "\"codigo\":\"" + m.Codigo + "\"," +
                                     ...
                                     "\"idmdfe\":\"" + m.Idmdfe + "\"," +
                                     "\"cnpjemitente\":\"" + m.Cnpjemitente + "\"," +
                                     "\"ufdestinatario\":\"" + m.Ufdestinatario + "\"," +
                                     "\"numero\":\"" + m.Numero + "\"," +
                                     "\"serie\":\"" + m.Serie + "\"," +
        ...
        public MdfeM1 ObterPorId(long id)
        {
            var m1 = new MdfeM1();
